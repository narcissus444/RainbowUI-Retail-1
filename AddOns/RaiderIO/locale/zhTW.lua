-- Generated from CurseForge on Tue Sep 24 06:56:47 UTC 2024
...
L["MINIMAP_SHORTCUT_MINIMAP_ENABLE_DESC"] = "啟用在小地圖周圍顯示圖示。"
...
L["SHOW_WARBAND_SCORE"] = "在工具提示上顯示戰隊的M+分數和進度"
L["SHOW_WARBAND_SCORE_DESC"] = "在工具提示上顯示玩家戰隊目前賽季的M+分數以及團隊進度。玩家必須在 Raider.IO 上註冊並同步其BNET，戰隊進度才能正常運作。"
L["TANK"] = "坦克"
