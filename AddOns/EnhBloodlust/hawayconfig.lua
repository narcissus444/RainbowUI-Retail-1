...
config.spells = {390386, 2825, 80353, 264667, 32182, 381301}
...
config.sound = {
	...
	"Interface/AddOns/EnhBloodlust/Zhang-zhe.mp3",
	"Interface/AddOns/EnhBloodlust/Zhang-zhe2.mp3",
	"Interface/AddOns/EnhBloodlust/Zhang-zhe3.mp3",
	"Interface/AddOns/EnhBloodlust/Zhang-zhe4.mp3",
	"Interface/AddOns/EnhBloodlust/Zhang-zhe5.mp3"
}
